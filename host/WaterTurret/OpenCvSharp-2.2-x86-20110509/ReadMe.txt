# Copyright (C) 2009-2011 by Schima
# schimatk@gmail.com
#
...
VS2008でコンパイルされたOpenCvSharpExtern.dllを標準添付しています。
もしVS2010でOpenCVをコンパイルし利用している場合は、「OpenCvSharpExtern.dll built by VC++2010」
というディレクトリの中にあるOpenCvSharpExtern.dllを使ってください。
